...
public class VpnServicem extends VpnService implements Handler.Callback {
    private static final String TAG = VpnServicem.class.getSimpleName();
    ...
    private void connect() {
        ...
        final Set<String> packages =
                prefs.getStringSet(VpnClient.Prefs.PACKAGES, Collections.<String>emptySet());
    ...
    private void updateForegroundNotification(final int message) {
        ...
        startForeground(1, new Notification.Builder(this, NOTIFICATION_CHANNEL_ID)
                .setSmallIcon(R.drawable.ic_launcher_background) //ic_vpn
